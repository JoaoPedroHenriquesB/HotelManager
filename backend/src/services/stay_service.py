...
from src.utils.exceptions import NotFoundError, RoomNotAvaliableError, DuplicateEntityError
...
class StayService:
  ...
  async def check_in(self, schema):
    existing_stay = await self.stay_repo.get_active_stay_by_guest_id(schema.guest_id)
